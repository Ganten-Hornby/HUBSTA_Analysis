...
datas, embeddings, exp_emb_list, ins_exp_mask, fea_ins_mask, xmask, labels = load_data_visemb_from_lightning_ckpt(
    # 'zzl_checkpoints_exp/best_model_mnist_exp_0.2_acc0.9657.pth', dataset='Mnist', T_num_layers=4, sample_rate_feature=0.2,
    # 'zzl_checkpoints_exp/kmnist/best_model_kmnist_acc0.7750999999999999.pth', dataset='KMnist', T_num_layers=8, sample_rate_feature=0.30,
