...
class Must_200115_08_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_200127_15_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_ME95_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_ME145_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_last_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_Ant_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_Adult_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class Must_MOB_Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
...
class KMnistDataset(DigitsDataset):
    def load_data(self, data_path, train=True):
        D = datasets.KMNIST(root=data_path, train=True,
...
class EMnistDataset(DigitsDataset):
    def load_data(self, data_path, train=True):
        D = datasets.EMNIST(root=data_path, train=True, split="byclass",
                            download=True, transform=None)
...
class Cifar10Dataset(DigitsDataset):
    def load_data(self, data_path, train=True):
        ...
        D = datasets.CIFAR10(root=data_path, train=True,
                           download=True, transform=None)
...
class Cifar100Dataset(DigitsDataset):
    ...
    def load_data(self, data_path, train=True):
        D = datasets.CIFAR100(root=data_path, train=True,
                           download=True, transform=None)
        data = np.array(D.data).astype(np.uint8)
        label = np.array(D.targets).reshape((-1))
