...
class DMTEVT_model(LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.ntrees=ntrees
        self.method=method
        self.tsne = dmtev.DMTEV(num_fea_aim=64)
        self.embedding = None
        self.x = None
        self.visited = False
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            self.tsne.fit_transform(data_input_item)
        return None
    def validation_step(self, batch, batch_idx, test=False, dataloader_idx=0):
        ...
        if dataloader_idx == 0:
            ...
            if self.visited:
                ...
                with torch.no_grad():
                    self.validation_step_outputs_vis = torch.tensor(self.tsne.transform(data_input_item))
