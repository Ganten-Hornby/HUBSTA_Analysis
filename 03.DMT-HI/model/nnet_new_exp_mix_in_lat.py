...
class DMTEVT_model(LightningModule):
    ...
    def forward(self, x, tau=100.0):
        ...
        if len(x.shape) == 2:
            ...
            weight = self.get_weight(cond=expanded_cond)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_all = (loss_emb + loss_lat) / 2 + orthogonal_loss*0.01#+ loss_mse*self.hparams.weight_mse # + 0.1*orthogonal_loss#+ kloss# + mlm_loss / 10
