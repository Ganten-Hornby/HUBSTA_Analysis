...
class DMTEVT_model(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_all = ((1.0-self.hparams.weight_tail)*loss_emb + self.hparams.weight_tail*loss_lat) + orthogonal_loss*10#+ loss_mse*self.hparams.weight_mse # + 0.1*orthogonal_loss#+ kloss# + mlm_loss / 10
