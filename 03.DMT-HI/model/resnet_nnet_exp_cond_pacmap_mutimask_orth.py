...
class DMTEVT_model(LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.dec = self.InitNetworkMLP(NS=[2, 500, 500, num_input_dim], last_relu=False)
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_topo_ne, loss_topo_po = self.LossManifold(
            ...
            n_select_each_sample = self.hparams.n_select_each_sample,
        )
        ...
        loss_mse = ((self.dec(lat_vis)-data_input_item_rec)**2)[:data_input_item.shape[0]//2].mean()
