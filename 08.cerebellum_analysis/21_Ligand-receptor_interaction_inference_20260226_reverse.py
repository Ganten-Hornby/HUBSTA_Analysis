...
for i in names:
    save = i.replace('.h5ad', '')
    if os.path.exists(f'/data/work/05.cluster/FuseMap/20251103/2_cerebellum_single/cci_20260226/{save}.csv'):
        continue
    ...
    if os.path.exists(f'/data/work/05.cluster/FuseMap/20251103/2_cerebellum_single/cci_20260226/{save}.csv'):
        continue
    df_result.to_csv(f'/data/work/05.cluster/FuseMap/20251103/2_cerebellum_single/cci_20260226/{save}.csv')
