...
mesh = trimesh.load('/data/work/12.pl_ply/mesh/mhb.obj')
mesh.vertices[:, [1, 2]] = mesh.vertices[:, [2, 1]]
mesh.vertices[:, 2] = -mesh.vertices[:, 2]


for gene_name in [
    'TH','ALDH1A1','SLC6A3','NR4A2',
                  'FOXA1','FOXA2','EN1',
                  'LMX1A','PITX3', 'PAX5', 'SST', 'HOXA5', 'HOXB5', 'KCNJ6']:
    if os.path.exists(f'/data/work/12.pl_ply/20251117_result/mhb_gene_plot_02/{gene_name}.html'):
        continue
    ...
    plot += stl_mesh
    plot.camera = [2436.2743325080105,
                 -2381.878928731942,
                 -3376.878652531674,
                 2603.9246215820312,
                 1204.36279296875,
    ...
    with open(f'/data/work/12.pl_ply/20251117_result/mhb_gene_plot_02/{gene_name}.html', 'w') as fp:
